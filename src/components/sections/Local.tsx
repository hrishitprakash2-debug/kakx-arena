...
const areas = [
  "Wave City", "Raj Nagar", "Raj Nagar Extension", "Indirapuram", "Vaishali",
  "Kaushambi", "Crossings Republik", "Mohan Nagar", "Dasna", "Sahibabad",
];

export default function Local() {
  return (
    <section id="local" className="section-pad relative overflow-hidden bg-arena-panel">
      ...
      <div className="container-x relative max-w-4xl text-center">
        ...
        >
          Ghaziabad&apos;s Home Of <span className="text-gradient-green">Live Sport</span>
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          from Raj Nagar Extension, Indirapuram, Vaishali and Dasna.
        </motion.p>
