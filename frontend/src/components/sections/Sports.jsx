...
const accentMap = {
  orange: {
    ...
    border: "hover:border-arena-green/60",
  },
  gold: {
    glow: "group-hover:shadow-[0_20px_70px_-15px_rgba(74,222,128,0.45)]",
    text: "text-arena-lime",
    border: "hover:border-arena-lime/60",
  },
  green: {
    glow: "group-hover:shadow-[0_20px_70px_-15px_rgba(16,185,129,0.4)]",
    text: "text-emerald-500",
    border: "hover:border-emerald-500/60",
  },
  blue: {
    glow: "group-hover:shadow-[0_20px_70px_-15px_rgba(110,231,183,0.4)]",
...
function SportCard({ sport }) {
  ...
  return (
    <TiltCard>
      ...
      >
        {sport.badge && (
          <span className="absolute left-4 top-4 z-10 inline-flex items-center gap-1 rounded-full bg-arena-mint px-3 py-1 text-[10px] font-extrabold uppercase tracking-wider text-black">
        ...
        <div className="flex flex-1 flex-col p-6">
          ...
          <p
            className={`mt-0.5 text-xs font-semibold uppercase tracking-widest ${a.text}`}
          >
            {sport.surface}
          </p>
    ...
    <section id="sports" className="section-pad relative overflow-hidden">
      ...
      <div className="container-x relative">
        <div className="mb-12 flex flex-col items-start justify-between gap-6 sm:mb-16 lg:flex-row lg:items-end">
          ...
          >
            Every court, turf and net built for serious play. Transparent
            pricing — book directly on WhatsApp, no apps, no middlemen.
          </motion.p>
        </div>
        <motion.div
          variants={container}
