          ...
          {faqs.map((f, i) => {
            ...
            return (
              <motion.div
                ...
                className={`overflow-hidden rounded-xl border transition-colors duration-300 ${isOpen ? "border-arena-green/40 bg-arena-green/[0.06]" : "border-white/10 bg-arena-card"}`}
              >
                <button
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-5 w-5 shrink-0 text-arena-green transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`}
                  />
                </button>
