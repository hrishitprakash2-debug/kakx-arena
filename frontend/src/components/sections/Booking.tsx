...
export default function Booking() {
  ...
  /**
   * Fire-and-forget: log the booking to the backend API in the background.
   * WhatsApp remains the primary booking channel — if the API is not
   * configured (VITE_API_URL) or unreachable, nothing breaks.
   */
  const logBookingToApi = () => {
    ...
    fetch(`${apiBase}/api/booking`, {
      ...
      /* tracking/logging must never break the booking flow */
    });
  };
